...
def is_E(line, cursor):
    ...
    # Also handle CMS v41+ formatting where NON-ORPCS code lines lack indentation.
    ...
    with open(fn) as fp:
        for line in fp:
            ...
            if line.strip() == "":
                ...
                cursor = "C"
            elif is_E(line, cursor):  # check E before D: unindented code lines look like D otherwise
                cursor = "E"
